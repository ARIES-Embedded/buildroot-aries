...
More information about the Aries Embedded MCV System on Module (SoM)
and EVP can be found at:

  - http://www.aries-embedded.de/?q=MCV
  - http://www.aries-embedded.de/?q=MCVEVP

Build
-----

How to build the BSP images is described in the README.md file
